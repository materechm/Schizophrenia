...
def main():
    fileName = "/Users/mtchavez/Documents/SZ/Diseasome/GWAS.txt" #location of GWAS catalog in computer
    path = "/users/mtchavez/Documents/SZ/Diseasome/graph.gml" #location where you want to store gml file
    dgm = DiseaseGeneManager(fileName)
    dgm.load_data_from_csv()
    dgm.computeNetwork("Schizophrenia")     #Schizophrenia overlap with GWAS database
